...
if __name__=='__main__':
    # trainval
    # dataroot = '/opt/data/common/nuScenes_org/data_v1.0-trainval'
    # save_dir = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes/samples_point_label'

    # mini
    dataroot = '/opt/data/private/codeN1/BEVDet/data/nuscenes-mini/'
    save_dir = '/opt/data/private/codeN1/BEVDet/data/nuscenes-mini/samples_point_label'
