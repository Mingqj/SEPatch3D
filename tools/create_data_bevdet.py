...
def nuscenes_data_prep(root_path, save_path, info_prefix, version, max_sweeps=10):
    ...
    nuscenes_converter.create_nuscenes_infos(
        root_path, save_path, info_prefix, version=version, max_sweeps=max_sweeps)
...
def add_ann_adj_info(extra_tag):
    ...
    for set in ['train', 'val']:
        dataset = pickle.load(
            open('/opt/data/private/codeN2/DualBEV/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set), 'rb'))
        ...
        with open('/opt/data/private/codeN2/DualBEV/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set),
                  'wb') as fid:
...
if __name__ == '__main__':
    ...
    save_path = '/opt/data/private/codeN2/DualBEV/data/nuscenes/'
    # train_version = f'{version}-mini'

    # root_path = '/opt/data/private/codeN1/BEVDet/data/nuscenes-mini/'
