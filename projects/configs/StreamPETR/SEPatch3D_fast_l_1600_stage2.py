...
model = dict(
    ...
    use_grid_mask=True,
    test_time_print=True, # print test time
    img_backbone = dict(
        type='LIGHT_EVA_FLEXIViT',
        img_size=320,
        patch_size=16,
        patch_size_seq=(18, 20),
        base_pos_embed_size=14,
        window_size=16,
...
data_root = '/opt/data/private/codeN1/mmdetection3d/data/nuscenes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file="/opt/data/private/codeN1/mmdetection3d/data/nuscenes/nuscenes2d_temporal_infos_train_load.pkl",
        num_frame_losses=num_frame_losses,
        ...
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, ann_file="/opt/data/private/codeN1/mmdetection3d/data/nuscenes/nuscenes2d_temporal_infos_val_load.pkl", classes=class_names, modality=input_modality),
    test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, ann_file="/opt/data/private/codeN1/mmdetection3d/data/nuscenes/nuscenes2d_temporal_infos_val_load.pkl", classes=class_names, modality=input_modality),
...
load_from="/opt/data/private/codeN3/ToC3D/work_dirs/stream_petr_eva_flexivit_fast_l_1600_stage1/iter_84384.pth"
resume_from=None
