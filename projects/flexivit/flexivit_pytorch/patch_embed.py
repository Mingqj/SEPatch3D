...
from projects.flexivit.flexivit_pytorch.utils import to_2tuple
...
class FlexiPatchEmbed(nn.Module):
    ...
    def pad_image(self, image, patch_size):
        """
        对图像进行padding，使得图像的高和宽都能被给定的patch_size整除。
        
        :param image: 输入图像，Tensor格式，形状为 [batch_size, channels, height, width]
