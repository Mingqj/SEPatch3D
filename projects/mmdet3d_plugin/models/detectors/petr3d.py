...
from projects.mmdet3d_plugin.models.backbones.toc3d_utils import ToC3DViTReturnType, LIGHTFlexiViTReturnType
...
class Petr3D(MVXTwoStageDetector):
    ...
    def extract_img_feat(
        ...
        if img is not None:
            ...
            # for ToC3D
            if isinstance(backbone_out, ToC3DViTReturnType) or isinstance(backbone_out, LIGHTFlexiViTReturnType):
    ...
    def forward(self, return_loss=True, **data):
        ...
        augmentations.
        """
        # print(data['img_metas'][0][0]['scene_token'])
        if return_loss:
